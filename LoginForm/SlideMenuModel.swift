...
class SlideViewModel
{
    ...
    {
        //remove all data from User Default
        ...
        UserDefaults.standard.set(false, forKey: "isUserGoogleLoggedIn")
        UserDefaults.standard.synchronize()
        
        //logout from google plus and firebase
